...
export class Coliseditdash extends Component{
    ...
    editColis(idColis){
      ...
      {/* Submit button */}
      <button type="submit" className="btn btn-outline-primary" style={{ marginLeft: '40%'}}  onClick={this.saveCoulis}>Modifier</button>
    </form>
